function resetWorld(newSeed, isBot) {
  ...
  hero.x=0;hero.y=0;hero.vx=0;hero.vy=0;hero.attached=false;hero.anchor=null;hero.lastAnchor=null;
  hero.grabs=0;hero.attachT=0;
  camY=viewH*0.12; camFreeze=3.5; runT=0; maxAlt=0; coinsRun=0; combo=0; maxCombo=0;
  shieldT=0; dying=false; reviveAvail=!isBot; revivePoint={x:0,y:-2.5};
  bot=!!isBot;
  spawnAhead();
}