...
const CAMERA = {
    ...
    speedMin: 3.6,         // ← минимальная скорость (wMin × rMin)
    // Скорость при которой достигается максимум
    speedThreshold: 16,    // ← уменьшили с 20 до 12 (камера отдаляется раньше)

    // Плавность изменения (меньше = плавнее)
    smoothness: 0.8,       // ← уменьшили с 2 до 0.8 (меньше рывков)
