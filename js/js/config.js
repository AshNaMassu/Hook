...
const CAMERA = {
    // Динамическая камера
    viewWidthMin: 10,      // минимальный обзор (старт, низкая скорость)
    viewWidthMax: 16,      // максимальный обзор (высокая скорость)
    speedThreshold: 20,    // скорость при которой достигается максимум
    smoothness: 2,         // плавность изменения (больше = быстрее)
